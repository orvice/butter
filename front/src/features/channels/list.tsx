      ...
      <CardHeader className='flex flex-row items-start justify-between gap-2 pb-2'>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align='end'>
            <DropdownMenuItem
              onClick={() => navigate({ to: '/channels/$name/edit', params: { name: channel.name } })}
            >
          ...
          <CardContent className='space-y-6 pt-5'>
            <div className='rounded-lg border p-4'>
              ...
              <div className='relative rounded-lg border border-border bg-muted/60 p-4 pe-12 font-mono text-[13px]'>
                <Button
                  size='icon'
                  variant='ghost'
                  className='absolute end-3 top-3 size-8 text-muted-foreground'
            ...
            <div>
              <div className='mb-4 flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center'>
                ...
                <Button className='w-full sm:w-auto' variant='outline' onClick={() => navigate({ to: '/api-tokens' })}>
