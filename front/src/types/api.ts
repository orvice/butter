...
export type MCPOAuthConnectionState =
  | "MCP_OAUTH_CONNECTION_STATE_UNSPECIFIED"
  | "MCP_OAUTH_CONNECTION_STATE_DISCONNECTED"
  | "MCP_OAUTH_CONNECTION_STATE_CONNECTED"
  | "MCP_OAUTH_CONNECTION_STATE_REAUTHORIZATION_REQUIRED"
  | "MCP_OAUTH_CONNECTION_STATE_ERROR";
