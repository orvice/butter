...
const (
	...
	AuthServiceName = "agents.v1.AuthService"
)
...
const (
	...
	AuthServiceLoginProcedure = "/agents.v1.AuthService/Login"
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_agents_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// Me calls agents.v1.AuthService.Me.
...
// Logout calls agents.v1.AuthService.Logout.
...
func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("agents.v1.AuthService.Login is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) Me(context.Context, *connect.Request[v1.MeRequest]) (*connect.Response[v1.MeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("agents.v1.AuthService.Me is not implemented"))
}
